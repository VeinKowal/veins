...
export class ZippedMTLLoader extends Loader {
  ...
  load(
    ...
    onLoad: (materialCreator: ZippedMTLLoader.MaterialCreator) => void,
    onProgress?: (event: ProgressEvent) => void,
    onError?: (event: ErrorEvent) => void,
  ): void;
  parse(text: string, path: string): ZippedMTLLoader.MaterialCreator;
...
export namespace ZippedMTLLoader {
