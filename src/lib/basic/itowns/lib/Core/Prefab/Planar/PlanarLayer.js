...
var PlanarLayer = /*#__PURE__*/ (function (_TiledGeometryLayer) {
  ...
  function PlanarLayer(id, extent, object3d) {
    ...
    _this = _super.call(
      ...
      [extent],
      new _PlanarTileBuilder['default']({
        crs: extent.crs,
      }),
      config,
    );
    ...
    _this.minSubdivisionLevel =
      _this.minSubdivisionLevel == undefined ? 0 : _this.minSubdivisionLevel;
    _this.maxSubdivisionLevel =
      _this.maxSubdivisionLevel == undefined ? 5 : _this.maxSubdivisionLevel;
