...
var PlanarTileBuilder = /*#__PURE__*/ (function () {
  function PlanarTileBuilder() {
    ...
    if (options.projection) {
      console.warn(
        'PlanarTileBuilder projection parameter is deprecated, use crs instead.',
      );
  ...
  (0, _createClass2['default'])(PlanarTileBuilder, [
    ...
    },
    {
      ...
      value: function uProjecte(u, params) {
        params.projected.x =
          params.extent.west + u * (params.extent.east - params.extent.west);
    ...
    },
    {
      ...
      value: function vProjecte(v, params) {
        params.projected.y =
          params.extent.south + v * (params.extent.north - params.extent.south);
      },
    },
    {
