...
var skyShader = {
  ...
  fragmentShader: [
    ...
    'uniform vec3 up;',
    'varying vec3 vWorldPosition;', // "vec3 cameraPos = cameraPosition; //vec3(0., 0., 0.);",
    ...
    '{',
    'return 0.0005 / vec3(94, 40, 18);', // return 0.00054532832366 / (3.0 * 2.545E25 * pow(vec3(680E-9, 550E-9, 450E-9), vec3(4.0)) * 6.245);
    '}',
    ...
    '// rayleigh coefficients', // "vec3 betaR = totalRayleigh(lambda) * reileighCoefficient;",
