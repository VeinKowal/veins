...
function WGS84ToOneSubY(latitude) {
  return (
    ...
    (0.5 -
      Math.log(
        Math.tan(PI_OV_FOUR + THREE.MathUtils.degToRad(latitude) * 0.5),
      ) *
        INV_TWO_PI)
  );
}
...
var BuilderEllipsoidTile = /*#__PURE__*/ (function () {
  function BuilderEllipsoidTile() {
    ...
    this.tmp = {
      coords: [
        new _Coordinates['default']('EPSG:4326', 0, 0),
        new _Coordinates['default']('EPSG:4326', 0, 0),
      ],
  ...
  (0, _createClass2['default'])(BuilderEllipsoidTile, [
    {
      ...
      value: function prepare(params) {
        ...
        params.quatNormalToZ = quatNormalToZ.setFromAxisAngle(
          ...
          -(
            Math.PI * 0.5 -
            THREE.MathUtils.degToRad(params.extent.center().latitude)
          ),
    ...
    },
    {
      ...
      value: function uProjecte(u, params) {
        params.projected.longitude =
          params.extent.west + u * this.tmp.dimension.x;
    ...
    },
    {
      ...
      value: function vProjecte(v, params) {
        params.projected.latitude =
          params.extent.south + v * this.tmp.dimension.y;
      },
    },
    {
      ...
      value: function computeSharableExtent(extent) {
        ...
        var sharableExtent = new _Extent['default'](
          extent.crs,
          -sizeLongitude,
          sizeLongitude,
          extent.south,
        ...
        var rotLon = THREE.MathUtils.degToRad(
          extent.west - sharableExtent.west,
        );
        var rotLat = THREE.MathUtils.degToRad(
          90 - extent.center(this.tmp.coords[0]).latitude,
        );
