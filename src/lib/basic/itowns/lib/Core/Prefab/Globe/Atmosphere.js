...
var _GeometryLayer2 = _interopRequireDefault(
  require('../../../Layer/GeometryLayer'),
);
...
var _CoordStars = _interopRequireDefault(
  require('../../Geographic/CoordStars'),
);
...
var Atmosphere = /*#__PURE__*/ (function (_GeometryLayer) {
  ...
  function Atmosphere() {
    ...
    basicAtmosphereOut.scale
      .copy(_Ellipsoid.ellipsoidSizes)
      .multiplyScalar(1.14);
    ...
    _this.realisticAtmosphereInitParams = options.Kr
      ? options
      : {
          Kr: 0.0025,
          Km: 0.0015,
      ...
      value: function preUpdate(context) {
        ...
        if (this.fog.enable) {
          ...
          this.fog.distance =
            mfogDistance *
            Math.pow(
              ((len - _Ellipsoid.ellipsoidSizes.x * 0.99) * 0.25) /
        ...
        if (altitude < limitAlti) {
          colorSky
            .copy(spaceColor)
            .lerp(skyBaseColor, (limitAlti - altitude) / limitAlti);
      ...
      value: function _initRealisticLighning() {
        ...
        var uniformsAtmosphere = {
          ...
          fScaleOverScaleDepth: {
            value:
              1 /
              (atmosphere.outerRadius - atmosphere.innerRadius) /
              atmosphere.scaleDepth,
          },
          g: {
            value: atmosphere.g,
          },
        ...
        var geometryAtmosphereIn = new THREE.SphereGeometry(
          atmosphere.innerRadius,
          50,
          50,
        );
        ...
        var geometryAtmosphereOut = new THREE.SphereGeometry(
          atmosphere.outerRadius,
          196,
          196,
        );
        ...
        skyDome.material.uniforms.mieCoefficient.value =
          effectController.mieCoefficient;
        skyDome.material.uniforms.mieDirectionalG.value =
    ...
    },
    {
      ...
      value: function setRealisticOn(bool) {
        ...
        if (bool) {
          ...
          this.realisticLightingPosition = _CoordStars['default']
            .getSunPositionInScene(new Date().getTime(), 48.85, 2.35)
            .normalize();
          this.realisticAtmosphere.children.forEach(function (obj) {
            return obj.material.uniforms.v3LightPosition.value.copy(
              _this2.realisticLightingPosition,
            );
          });
        }
