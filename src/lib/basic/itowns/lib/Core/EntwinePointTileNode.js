...
var EntwinePointTileNode = /*#__PURE__*/ (function (_PointCloudNode) {
  ...
  function EntwinePointTileNode(depth, x, y, z, layer) {
    ...
    _this.url = ''
      .concat(_this.layer.source.url, '/ept-data/')
      .concat(_this.id, '.')
      .concat(_this.layer.source.extension);
    return _this;
  }
    ...
    },
    {
      ...
      value: function loadOctree() {
        ...
        return _Fetcher['default']
          .json(
            ''
              .concat(this.layer.source.url, '/ept-hierarchy/')
              .concat(this.id, '.json'),
    ...
    },
    {
      ...
      value: function findAndCreateChild(depth, x, y, z, hierarchy, stack) {
        ...
        if (typeof numPoints == 'number') {
          var child = new EntwinePointTileNode(
            depth,
            x,
            y,
            z,
