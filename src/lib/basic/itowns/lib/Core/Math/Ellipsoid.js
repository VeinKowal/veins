...
var ellipsoidSizes = new THREE.Vector3(
  _proj['default'].WGS84.a,
  _proj['default'].WGS84.a,
  _proj['default'].WGS84.b,
);
  ...
  (0, _createClass2['default'])(Ellipsoid, [
    ...
    },
    {
      ...
      value: function cartesianToCartographic(position) {
        var target =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : new _Coordinates['default']('EPSG:4326', 0, 0, 0);
    ...
    },
    {
      ...
      value: function intersection(ray) {
        ...
        var c =
          ...
          O_C.z * O_C.z * this._invRadiiSquared.z -
          1;
        var d = b * b - 4 * a * c;
    ...
    },
    {
      ...
      value: function computeDistance(coordCarto1, coordCarto2) {
        ...
        var rho =
          (a * (1 - e * e)) /
          Math.sqrt(1 - e * e * Math.sin(latMoy) * Math.sin(latMoy));
