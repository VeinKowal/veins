  ...
  (0, _createClass2['default'])(C3DTileset, [
    {
      ...
      value: function parseTiles(tile, baseURL, parent, registeredExtensions) {
        ...
        tile.transform = tile.transform
          ...
          : undefined; // The only reason to store _worldFromLocalTransform is because of
          ...
          if (tile.transform) {
            tile._worldFromLocalTransform =
              new THREE.Matrix4().multiplyMatrices(
                parent._worldFromLocalTransform,
                tile.transform,
              );
          } else {
        ...
        if (
          (tile.viewerRequestVolume && tile.viewerRequestVolume.region) ||
        ...
        tile.viewerRequestVolume = tile.viewerRequestVolume
          ? new _C3DTBoundingVolume['default'](
