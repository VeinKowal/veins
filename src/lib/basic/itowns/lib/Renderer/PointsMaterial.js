...
var PointsMaterial = /*#__PURE__*/ (function (_THREE$RawShaderMater) {
  ...
  function PointsMaterial() {
    ...
    var applyOpacityClassication =
      options.applyOpacityClassication == undefined
        ? false
        : options.applyOpacityClassication;
    ...
    _CommonMaterial['default'].setUniformProperty(
      (0, _assertThisInitialized2['default'])(_this),
      'overlayColor',
      options.overlayColor || new THREE.Vector4(0, 0, 0, 0),
    );
    ...
    if (oiMaterial) {
      _this.uniforms.projectiveTextureAlphaBorder =
        oiMaterial.uniforms.projectiveTextureAlphaBorder;
      _this.uniforms.projectiveTextureDistortion =
        oiMaterial.uniforms.projectiveTextureDistortion;
      _this.uniforms.projectiveTextureMatrix =
        oiMaterial.uniforms.projectiveTextureMatrix;
      ...
      _this.defines.ORIENTED_IMAGES_COUNT =
        oiMaterial.defines.ORIENTED_IMAGES_COUNT;
  ...
  (0, _createClass2['default'])(PointsMaterial, [
    ...
    },
    {
      ...
      value: function copy(source) {
        (0, _get2['default'])(
          (0, _getPrototypeOf2['default'])(PointsMaterial.prototype),
          'copy',
          this,
        ).call(this, source);
        ...
        if (source.uniforms.projectiveTextureAlphaBorder) {
          ...
          this.uniforms.projectiveTextureAlphaBorder =
            source.uniforms.projectiveTextureAlphaBorder;
          ...
          this.uniforms.projectiveTextureMatrix =
            source.uniforms.projectiveTextureMatrix;
