...
exports.RasterElevationTile =
  exports.RasterColorTile =
  exports['default'] =
  exports.EMPTY_TEXTURE_ZOOM =
    void 0;
...
var RasterTile = /*#__PURE__*/ (function (_THREE$EventDispatche) {
  ...
  function RasterTile(material, layer) {
    ...
    _this.layer = layer;
    _this.crs = layer.parent.tileMatrixSets.indexOf(
      _Crs['default'].formatToTms(layer.crs),
    );
...
var RasterElevationTile = /*#__PURE__*/ (function (_RasterTile2) {
  ...
  function RasterElevationTile(material, layer) {
    ...
    if (layer.useRgbaTextureElevation) {
      ...
      scaleFactor =
        layer.colorTextureElevationMaxZ - layer.colorTextureElevationMinZ;
  ...
  (0, _createClass2['default'])(RasterElevationTile, [
    {
      ...
      value: function initFromParent(parent, extents) {
        (0, _get2['default'])(
          (0, _getPrototypeOf2['default'])(RasterElevationTile.prototype),
          'initFromParent',
          this,
        ).call(this, parent, extents);
    ...
    },
    {
      ...
      value: function setTextures(textures, offsetScales) {
        ...
        (0, _get2['default'])(
          ...
          'setTextures',
          this,
        ).call(this, textures, offsetScales);
        this.updateMinMaxElevation();
      },
    },
    {
      ...
      value: function updateMinMaxElevation() {
        if (this.textures[0] && !this.layer.useColorTextureElevation) {
          var _computeMinMaxElevati = (0, _XbilParser.computeMinMaxElevation)(
              this.textures[0],
              this.offsetScales[0],
    ...
    },
    {
      ...
      value: function replaceNoDataValueFromTexture(texture) {
        ...
        var parentDataElevation =
          parentTexture && parentTexture.image && parentTexture.image.data;
        var dataElevation = texture.image && texture.image.data;

        if (
          dataElevation &&
          parentDataElevation &&
          !(0, _XbilParser.checkNodeElevationTextureValidity)(
            dataElevation,
            nodatavalue,
          )
        ) {
          texture.extent.offsetToParent(parentTexture.extent, pitch);
          (0, _XbilParser.insertSignificantValuesFromParent)(
            dataElevation,
            parentDataElevation,
            nodatavalue,
            pitch,
