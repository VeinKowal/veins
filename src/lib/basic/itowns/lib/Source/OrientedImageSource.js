...
var OrientedImageSource = /*#__PURE__*/ (function (_Source) {
  ...
  function OrientedImageSource(source) {
    ...
    var promises = [];
    promises.push(
      source.orientationsUrl
        ? _Fetcher['default'].json(source.orientationsUrl, _this.networkOptions)
        : Promise.resolve(),
    );
    promises.push(
      source.calibrationUrl
        ? _Fetcher['default'].json(source.calibrationUrl, _this.networkOptions)
        : Promise.resolve(),
    );
