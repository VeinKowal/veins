...
var _textureConverter = _interopRequireDefault(
  require('../Converter/textureConverter'),
);
  ...
  (0, _createClass2['default'])(RasterLayer, [
    {
      ...
      value: function convert(data, extentDestination) {
        return _textureConverter['default'].convert(
          data,
          extentDestination,
          this,
        );
      ...
      value: function _delete() {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            root.traverse(
              (0,
              _LayeredMaterialNodeProcessing.removeLayeredMaterialNodeLayer)(
                this.id,
              ),
            );
          }
