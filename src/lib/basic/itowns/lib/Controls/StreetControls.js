...
var _FirstPersonControls2 = _interopRequireDefault(
...
function pick(event, view, buildingsLayer) {
  ...
  var buildings = buildingsLayer
    ? view.pickObjectsAt(event, -1, buildingsLayer)
...
var StreetControls = /*#__PURE__*/ (function (_FirstPersonControls) {
  ...
  function StreetControls(view) {
    ...
    _this._onMouseOut = (0, _get2['default'])(
      ((_thisSuper = (0, _assertThisInitialized2['default'])(_this)),
      (0, _getPrototypeOf2['default'])(StreetControls.prototype)),
      'onMouseUp',
      _thisSuper,
    ...
    _this.transformationPositionPickOnTheGround =
      options.transformationPositionPickOnTheGround ||
      function (position) {
        return position;
      };
      ...
      value: function onMouseUp(event) {
        ...
        if (this._stateOnMouseDrag) {
          ...
          pick(
            ...
            this.view,
            this.buildingsLayer,
            this.onClickOnGround.bind(this),
            this.onClickOnWall.bind(this),
          );
        }
      },
    },
    ...
    },
    {
      ...
      value: function animateCameraLookAt(position, time) {
        ...
        this.tween = new _tween['default'].Tween(
          ...
          .easing(_tween['default'].Easing.Quadratic.Out)
          .onComplete(function () {
            _this3.stopAnimations();
          })
          .onUpdate(function (d) {
            // 'manually' slerp the Quaternion to avoid rotation issues
            _this3.camera.quaternion.slerpQuaternions(
              startQuaternion,
              _this3.end.quaternion,
              d.t,
            );
          })
          .start();
    ...
    },
    {
      ...
      value: function moveCameraTo(position) {
        ...
        this.tween = new _tween['default'].Tween(
          ...
          this.tweenGroup,
        ) // Create a new tween that modifies camera position
          .to(position.clone(), time)
          .easing(_tween['default'].Easing.Quadratic.Out) // Use an easing function to make the animation smooth.
          .onComplete(function () {
    ...
    },
    {
      ...
      value: function onKeyDown(e) {
        ...
        (0, _get2['default'])(
          ...
          'onKeyDown',
          this,
        ).call(this, e); // key to move to next position (default to Z)
