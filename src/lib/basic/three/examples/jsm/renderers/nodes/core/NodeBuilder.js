  ...
  build() {
    ...
    for (const shaderStage of shaderStages) {
      this.define(
        ...
        this.getUniformsHeaderSnippet(shaderStage),
      );
      this.define(
        shaderStage,
        'NODE_HEADER_ATTRIBUTES',
        this.getAttributesHeaderSnippet(shaderStage),
      );
      this.define(
        shaderStage,
        'NODE_HEADER_VARYS',
        this.getVarysHeaderSnippet(shaderStage),
      );

      this.define(
        shaderStage,
        'NODE_BODY_VARYS',
        this.getVarysBodySnippet(shaderStage),
      );
