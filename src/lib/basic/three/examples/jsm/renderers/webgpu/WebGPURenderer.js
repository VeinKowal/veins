...
class WebGPURenderer {
  constructor(parameters = {}) {
    ...
    this._parameters.nonGuaranteedFeatures =
      parameters.nonGuaranteedFeatures === undefined
        ? []
        : parameters.nonGuaranteedFeatures;
    this._parameters.nonGuaranteedLimits =
      parameters.nonGuaranteedLimits === undefined
        ? {}
        : parameters.nonGuaranteedLimits;
  }
  ...
  async init() {
    ...
    const context =
      parameters.context !== undefined
        ? parameters.context
        : this.domElement.getContext('gpupresent');
    ...
    this._textures = new WebGPUTextures(
      device,
      this._properties,
      this._info,
      compiler,
  ...
  render(scene, camera) {
    ...
    if (renderTarget !== null) {
      ...
      if (this._parameters.antialias === true) {
        ...
        colorAttachment.resolveTarget = this._swapChain
          .getCurrentTexture()
          .createView();
      } else {
        colorAttachment.attachment = this._swapChain
          .getCurrentTexture()
          .createView();
  ...
  _setupVertexBuffers(geometryAttributes, encoder, pipeline) {
    const shaderAttributes =
      this._renderPipelines.getShaderAttributes(pipeline);
